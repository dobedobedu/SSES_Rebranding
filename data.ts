...
targetCompanies: {
    tier1: [
      { 
        name: 'MITER Brands (formerly PGT)', 
        jobs: '245 active postings', 
        likelihood: 'Medium', 
        reason: 'Acquired PGT Innovations March 2024. Venice/Nokomis facility operational. $1.2M tuition reimbursement program.',
        distanceMiles: 8,
        estimatedFamilies: '60-120',
        urgencyLevel: 3,
        urgencyLabel: '●●● ACTIVE HIRING',
        sector: 'Manufacturing',
        salaryRange: '$50K-$80K',
        remoteFriendly: false,
        source: 'LinkedIn + company careers, Feb 2026'
      },
      { 
        name: 'Sarasota Memorial Health Care System', 
        jobs: '421 active postings', 
        ...
        distanceMiles: 12,
        estimatedFamilies: '170-210',
        urgencyLevel: 5,
        urgencyLabel: '●●●●● MASSIVE HIRING',
        sector: 'Healthcare',
        salaryRange: '$60K-$150K+',
        remoteFriendly: false,
        source: 'careers.smh.com, Feb 2026'
      },
      { 
        name: 'Lakewood Ranch Medical Center', 
        jobs: '92 active postings', 
        likelihood: 'High', 
        reason: 'Part of UHS network. Serving fastest-growing master-planned community in U.S. (30,000+ residents).',
        distanceMiles: 15,
        estimatedFamilies: '35-55',
        urgencyLevel: 3,
        urgencyLabel: '●●● ACTIVE HIRING',
        sector: 'Healthcare',
        salaryRange: '$55K-$120K',
        remoteFriendly: false,
        source: 'careers.uhs.com, Feb 2026'
      },
      { 
        name: 'Benderson Development', 
        jobs: '29 active postings', 
        likelihood: 'Medium', 
        reason: 'Regional HQ in Sarasota since 2004. 1,065 properties in 40 states. Development pipeline in Sarasota-Manatee.',
        distanceMiles: 10,
        estimatedFamilies: '10-20',
        urgencyLevel: 2,
        urgencyLabel: '●● MODERATE HIRING',
        sector: 'Real Estate',
        salaryRange: '$70K-$120K',
        remoteFriendly: false,
        source: 'LinkedIn, Feb 2026'
      }
    ],
    tier2: [
      { 
        name: 'HCA Florida Sarasota Doctors Hospital', 
        jobs: '42 active postings', 
        likelihood: 'Medium', 
...
id: 'corp-t1',
      ...
      description: 'Real-time hiring: 421 active postings at Sarasota Memorial, 245 at MITER Brands (acquired PGT), 92 at Lakewood Ranch Medical. Healthcare leads with 630-750 total openings. Tech companies offer remote work from Bradenton/Sarasota.',
      actions: [
        { id: 'c1-a1', text: 'Reach out to MITER Brands HR (245 active postings, 8 miles away) - Venice/Nokomis facility', priority: 'immediate' },
        { id: 'c1-a2', text: 'Partner with Sarasota Memorial Health Care (421 active postings) - Create "Healthcare Relocation Package"', priority: 'immediate' },
      ...
      rightPanelData: {
        tier1: [
          ...
          },
          {
            ...
            salaryRange: '$55K-$130K',
            remoteFriendly: false,
            source: 'careers.hcahealthcare.com, Feb 2026'
          }
        ],
        tier2: [
          { 
...
id: 'corp-t2',
      ...
      description: 'Healthcare leads with 630-750 validated openings (421 at Sarasota Memorial, 92 at Lakewood Ranch Medical). Focus on healthcare worker relocations. MITER Brands ($1.2M tuition reimbursement, 245 postings) is a target. Tech companies offer remote work from Bradenton/Sarasota.',
      actions: [
        ...
        { id: 'c2-a2', text: 'Create MITER Brands partnership package (245 active postings, tuition reimbursement program)', priority: 'immediate' },
